...
class Asaro extends StatefulWidget {
  ...
  Asaro({required this.foodName, required this.imagePath, required this.price});

  @override
  _AsaroState createState() => _AsaroState();
}

class _AsaroState extends State<Asaro> {
  int itemCount = 0;
