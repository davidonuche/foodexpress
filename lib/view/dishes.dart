...
class DishDetailsPage extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildAddToCartButton(menuItem, itemCount),
          ],
        ),
      ),
    );
  ...
  Widget _buildAddToCartButton(MenuItem menuItem, int itemCount) {
    return Row(
      children: [
        Container(
          decoration: BoxDecoration(
        ...
        ElevatedButton(
          onPressed: () {
            ...
            print('Added ${itemCount}x ${menuItem.name} to cart');
            // You can further enhance this logic, e.g., update a global cart state
          },
